...
<img width="364" height="460" alt="image" src="https://github.com/user-attachments/assets/80edb5d0-ea64-407a-9313-f4ff9a4ab990" />
...
假如说在c阶段，S1提交了任期2的数据，那么如果出现d，则会导致任期2数据被覆盖，丢失。也就是
